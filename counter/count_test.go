...
func TestPrint(t *testing.T) {
	testCases := []struct {
		...
		{
			name: "simple five words with filename show all",
			counts: counter.Counts{
				Lines: 1,
				Words: 5,
				Bytes: 24,
			},
			opts:      display.NewOptions(true, true, true, false),
		...
		},
		{
			...
			opts:      display.NewOptions(false, false, true, false),
			filenames: []string{"words.txt"},
			wants:     "1\t words.txt\n",
		},
		{
			...
			opts:      display.NewOptions(false, true, false, false),
			filenames: []string{"words.txt"},
			wants:     "5\t words.txt\n",
		},
		{
			...
			opts:      display.NewOptions(true, false, false, false),
			filenames: []string{"words.txt"},
			wants:     "24\t words.txt\n",
		},
		{
			...
			opts:      display.NewOptions(true, false, true, false),
			filenames: []string{"words.txt"},
		...
		},
		{
			...
			opts:      display.NewOptions(true, true, false, false),
			filenames: nil,
			wants:     "5\t24\t\n",
		},
		{
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			tc.counts.Print(buffer, tc.opts, tc.filenames...)
...
func TestPrintHeader(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			opts:  display.NewOptions(false, false, false, false),
		...
		},
		{
			...
			opts:  display.NewOptions(false, true, true, false),
			wants: "lines\twords\t\n",
		},
	}
